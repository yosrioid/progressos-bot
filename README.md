...
GROQ_STRUCTURED_OUTPUT_MODE=off
...
High-risk deployments can set `CAPTURE_PRE_PARSER_GUARD_MODE=basic` to block obvious
prompt-injection and secret-exfiltration text before parser calls.
